...
def main():
    ...
    console.print(
        f"  • Exkluderade: [yellow]{', '.join(EXCLUDE_PATTERNS[:5])}...[/yellow]\n"
    )
    ...
    project_name = Prompt.ask("Projektnamn", default=default_name)
    ...
    console.print(
        f"  4. [yellow]python show_columns.py[/yellow] (testa att allt fungerar)"
    )
    console.print(
