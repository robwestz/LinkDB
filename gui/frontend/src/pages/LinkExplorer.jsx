...
const LinkExplorer = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Link Explorer</h1>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300">Pub Domain</th>
                <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300">Target URL</th>
                <th className="text-left py-3 px-4 text-gray-700 dark:text-gray-300">Anchor Text</th>
            ...
            <tbody>
              {links.map((link, i) => (
                <tr key={i} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  <td className="py-3 px-4 text-gray-900 dark:text-gray-100">{link.customer}</td>
                  <td className="py-3 px-4 text-gray-700 dark:text-gray-300">{link.pub_domain}</td>
                  <td className="py-3 px-4 text-gray-700 dark:text-gray-300 truncate max-w-xs">{link.target_url}</td>
                  <td className="py-3 px-4 text-gray-700 dark:text-gray-300">{link.anchor_text}</td>
                  <td className="py-3 px-4">
                    <Badge>{link.anchor_type}</Badge>
                  </td>
                  <td className="py-3 px-4 text-gray-700 dark:text-gray-300">{formatDate(link.published_at)}</td>
                </tr>
              ))}
            </tbody>
          </table>
