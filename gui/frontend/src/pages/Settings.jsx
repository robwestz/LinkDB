  ...
  return (
    <div>
      ...
      <Card title="Database Configuration" className="mb-6">
        <p className="text-gray-600 dark:text-gray-400 mb-4">Database path and backup settings</p>
        <Button>Configure</Button>
      </Card>

      <Card title="Analysis Thresholds">
        <p className="text-gray-600 dark:text-gray-400 mb-4">Customize warning thresholds</p>
